...
- To peek the compass chest, target the corner, sidehop left x4, sidehop right x2, then roll peek and look a bit to the left.

- In central pillar, you can swim far enough to load the room with the enemies (watch for the minimap to change), and then swim away from the room without irons on. Your camera will clip through the ceiling and you can peek the chest without having to kill all the enemies.

- You can reach the alcove to raise the water to the top floor either by hovering and grabbing the left side of the alcove. Without hovers, you can jump while holding Z and R, and then when Link grabs the ledge repeatedly, start mashing B. Holding out your shield will ensure Link only jumpslashes at the top of the glitchy animation, which is enough height to get into the alcove.
...
- When surfacing from water, you can tap irons twice to skip Link's breathing animation when he surfaces, letting you grab ledges immediately.