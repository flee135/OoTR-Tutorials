...
- Flare dancers can be knocked down by hammering any surface. You'll usually start the fight with a master sword jumpslash, and then crouch stab the center block with hammer, and the crouch stab the flare dancer again with the hammer (doing master sword damage), and repeating.

- You can jump from the hammer chest to the song of time block by the highest goron, letting you reach that switch without song of time.
