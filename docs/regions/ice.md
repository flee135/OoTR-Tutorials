...
- After finishing ice, if your plan is to leave and unfreeze KZ, you can go backwards and jump into the void in the ice puzzle room. This puts you back at the start of the dungeon.

## Good to Know

- You can skip the ice push puzzle with [glitchless jumps](https://www.youtube.com/watch?v=SBVAb83hgAg). If you have bombs, you can ground jump to each alcove instead.
