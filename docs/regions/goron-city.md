...
- As you're walking out of the maze, if you need to stop Link the goron, you can jump off to the left and pull a bomb right when you jump. The goron will always be in that spot when you leave the maze and the bomb will explode right when you meet him.

- You can reach the scrubs with [just a hookshot](https://www.youtube.com/watch?v=1hMFxLynpUQ). The slash in the beginning is optional, but without it the release timing is a one frame window.

## Optimizations

- You can leave the maze with Sun's Song. This is 6+ seconds faster than walking back to whichever entrance you came from. If you want to leave from a different entrance, it's better to walk out of the maze.